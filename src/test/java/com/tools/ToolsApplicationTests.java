...
public class ToolsApplicationTests {
    ...
    public void test1() {
        ...
        List<Integer> taskList = Arrays.asList(200, 1, 3, 4, 5, 6, 7, 8, 9, 10);
    ...
    public void testOne() {
        ...
        try {
            List<Object> one = csvUtils.csvReadOperation("E:\\deviceid.csv");
            List<Object> two = csvUtils.csvReadOperation("E:\\pyddeviceid.csv");
    ...
    public void testTaskPool() {
        long start = System.currentTimeMillis();
        try {
            List<Object> one = csvUtils.csvReadOperation("E:\\deviceid1.csv");

            List<Object> result = taskDeal.run(one, 1);
            System.out.println("条数："+one.size()+"耗时=" + (System.currentTimeMillis() - start));

            System.out.print("结果:" + result.size() + "\n");
